...
%prep
%setup -q -n google-auth-httplib2-0.1.1
cd %{_builddir}/google-auth-httplib2-0.1.1
pushd ..
cp -a google-auth-httplib2-0.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694467907
